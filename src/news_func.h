...
{
	AddNewsItem(string, type, NF_NO_TRANSPARENT | NF_SHADE | NF_THIN, vehicle, station == INVALID_STATION ? NewsReference{} : station);
}
...
{
	AddNewsItem(string, type, NF_NO_TRANSPARENT | NF_SHADE | NF_THIN, tile, station == INVALID_STATION ? NewsReference{} : station);
}
