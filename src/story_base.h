...
typedef Pool<StoryPageElement, StoryPageElementID, 64, STORY_PAGE_ELEMENT_END> StoryPageElementPool;
typedef Pool<StoryPage, StoryPageID, 64, STORY_PAGE_END> StoryPagePool;
