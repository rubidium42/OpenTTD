...
public:
	static const GroupID GROUP_ALL = ::ALL_GROUP; ///< All vehicles are in this group.
	static const GroupID GROUP_DEFAULT = ::DEFAULT_GROUP; ///< Vehicles not put in any other group are in this one.
	static const GroupID GROUP_INVALID = ::INVALID_GROUP; ///< An invalid group id.
